...
class DemoPage extends StatefulWidget {
  ...
  const DemoPage({Key? key, required this.page,this.callback}) : super(key: key);
...
class _DemoPageState extends State<DemoPage> {
  ...
  Widget build(BuildContext context) {
    return widget.page==1?Scaffold(
                  body: SafeArea(
                    bottom: false,
                    child: Image.network('https://wallpaperaccess.com/full/1559254.png'),
                  ),
                ):Scaffold(
      body: SafeArea(
        bottom: false,
